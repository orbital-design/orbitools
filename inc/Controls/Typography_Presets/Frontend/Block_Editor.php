...
class Block_Editor
{
    ...
    private function enqueue_preset_assets(): void
    {
        ...
        \wp_enqueue_script(
            ...
            ORBITOOLS_URL . 'build/admin/js/controls/typography-presets/editor-presets-attribute-registration.js',
            array('wp-hooks'),
            self::VERSION,
            true
        );
        ...
        \wp_enqueue_script(
            ...
            ORBITOOLS_URL . 'build/admin/js/controls/typography-presets/editor-disable-core-typography-controls.js',
        ...
        \wp_enqueue_script(
            ...
            ORBITOOLS_URL . 'build/admin/js/controls/typography-presets/editor-presets-register-controls.js',
            array(
                'wp-hooks',
                'wp-blocks',
                'wp-element',
        ...
        \wp_enqueue_script(
            ...
            ORBITOOLS_URL . 'build/admin/js/controls/typography-presets/editor-presets-classname-application.js',
            array(
                'wp-hooks',
                'wp-element',
                'wp-compose',
