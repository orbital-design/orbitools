...
/**
 * Column Widths Controls Asset Management
 *
 * Handles loading and management of CSS and JavaScript assets for the Column Widths Controls module.
 ...
 *
 * Manages CSS and JavaScript asset loading for the Column Widths Controls module.
 *
 * @since 1.0.0
 */
class Assets
{
    ...
    {
        $this->asset_url = ORBITOOLS_URL . 'modules/Column_Widths_Controls/';
    ...
    private function enqueue_frontend_styles(): void
    {
        ...
        $css_path = ORBITOOLS_DIR . 'modules/Column_Widths_Controls/css/frontend.css';
    ...
    private function enqueue_admin_styles(): void
    {
        ...
        $css_path = ORBITOOLS_DIR . 'modules/Column_Widths_Controls/css/admin.css';
    ...
    {
        return ORBITOOLS_DIR . 'modules/Column_Widths_Controls/' . ltrim($file, '/');
    }
