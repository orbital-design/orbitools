...
/**
 * Column Widths Controls Module
 *
 * Main coordinator class for the Column Widths Controls module. This class acts as
 * the primary entry point and orchestrates the various components of the module.
 *
 * @package    Orbitools
 * @subpackage Modules/Column_Widths_Controls
 * @since      1.0.0
 */

namespace Orbitools\Modules\Column_Widths_Controls;

use Orbitools\Modules\Column_Widths_Controls\Admin\Admin;
...
use Orbitools\Modules\Column_Widths_Controls\Core\Block_Helper;
use Orbitools\Modules\Column_Widths_Controls\Frontend\Block_Editor;
use Orbitools\Modules\Column_Widths_Controls\Frontend\Assets;
...
/**
 * Column Widths Controls Module Class
 *
 * Coordinates all aspects of the Column Widths Controls functionality by managing
 * the interaction between admin, core, and frontend components.
 *
 * @since 1.0.0
 */
class Column_Widths_Controls
{
    /**
     * Module version
     *
    ...
    /**
     * Initialize the Column Widths Controls module
     *
    ...
    /**
     * Clear all column widths related caches
     *
     * @since 1.0.0
     */
    public function clear_column_widths_cache(): void
    {
