...
/**
 * Column Widths Controls Settings Helper
 *
...
class Settings_Helper
{
    ...
    /**
     * Check if Column Widths Controls module is enabled
     *
     * @since 1.0.0
    ...
    {
        return self::get_setting('column_widths_controls_enabled', false);
    }
     ...
     */
    public static function output_column_widths_css(): bool
    {
        return self::get_setting('column_widths_output_css', true);
    }
